...
SRC="/home/obscura-build/branding/render"
...
# Clean old files so SVG leftovers don't stay behind
rm -f "$ROOT/usr/share/backgrounds/obscura/"*
rm -f "$ROOT/usr/share/obscura/branding/logo/"*

# Copy rendered PNG assets
install -m644 "$SRC/wallpapers/obscura-hero.png" "$ROOT/usr/share/backgrounds/obscura/obscura-hero.png"
install -m644 "$SRC/wallpapers/obscura-login.png" "$ROOT/usr/share/backgrounds/obscura/obscura-login.png"
install -m644 "$SRC/logo/obscura-sigil.png" "$ROOT/usr/share/obscura/branding/logo/obscura-sigil.png"

# Copy shell theme files
...
echo "==> Backgrounds:"
ls -lh "$ROOT/usr/share/backgrounds/obscura/"
echo "==> Logo:"
ls -lh "$ROOT/usr/share/obscura/branding/logo/"
